      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Siap Mewujudkan
            <span className="block text-yellow-300">Visi Kreatif Anda?</span>
          </h2>
          ...
          <div className="border-t border-white border-opacity-20 pt-8">
            <p className="text-sm opacity-80 mb-4">Dipercaya oleh 200+ klien dari berbagai industri</p>
          ...
          {/* Urgency Element */}
          <div className="mt-8 bg-white bg-opacity-10 rounded-lg p-4 inline-block">
