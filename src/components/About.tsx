        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right" data-aos-delay="100">
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6" data-aos="fade-up" data-aos-delay="400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-start" data-aos="zoom-in" data-aos-delay="600">
              ...
              <div className="flex items-start" data-aos="zoom-in" data-aos-delay="700">
                <div className="flex-shrink-0 w-12 h-12 bg-[#11808b] rounded-lg flex items-center justify-center mr-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start" data-aos="zoom-in" data-aos-delay="800">
                <div className="flex-shrink-0 w-12 h-12 bg-[#11808b] rounded-lg flex items-center justify-center mr-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start" data-aos="zoom-in" data-aos-delay="900">
                <div className="flex-shrink-0 w-12 h-12 bg-[#11808b] rounded-lg flex items-center justify-center mr-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative" data-aos="fade-left" data-aos-delay="200">
            <div className="relative z-10" data-aos="zoom-in" data-aos-delay="400">
              <Image
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-[#11808b] rounded-full opacity-20" data-aos="fade-in" data-aos-delay="600"></div>
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-[#11808b] to-[#0f6b75] rounded-full opacity-10" data-aos="fade-in" data-aos-delay="700"></div>
