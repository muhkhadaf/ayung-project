    ...
    try {
      ...
      if (response.ok) {
        ...
        reset({
          ...
          short_description: data.service.short_description,
          price: data.service.price,
          category: data.service.category,
          image: data.service.image,
          features: data.service.features?.map((feature: string) => ({ value: feature })) || [{ value: '' }]
        })
      } else {
  ...
  const onSubmit = async (data: ServiceFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(errorData.error || 'Gagal memperbarui service')
      }
    } catch (error) {
      toast.error('Terjadi kesalahan saat memperbarui service')
    } finally {
      setIsLoading(false)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/admin/services" className="text-blue-600 hover:text-blue-800 mt-2 inline-block">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t">
              ...
              >
                ...
                {isLoading ? 'Menyimpan...' : 'Perbarui Service'}
              </button>
            </div>
          </form>
        </div>
