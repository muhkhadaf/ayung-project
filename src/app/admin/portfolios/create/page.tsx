  ...
  const onSubmit = async (data: PortfolioFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(errorData.error || 'Gagal menambahkan portfolio')
      }
    } catch (error) {
      toast.error('Terjadi kesalahan saat menambahkan portfolio')
    } finally {
      setIsLoading(false)
    }
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Tambah Portfolio Baru</h1>
            </div>
          </div>
        </div>
      </header>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t">
              ...
              >
                ...
                {isLoading ? 'Menyimpan...' : 'Simpan Portfolio'}
              </button>
            </div>
          </form>
        </div>
